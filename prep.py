    ...
    for raw_data_dir in os.listdir(input_dir):
        ...
        if os.path.isdir(item):
            ...
            for filename in os.listdir(item):
                if filename.startswith("fingerprint0"): # as init, only use the first one
            ...
            generate_graph_file(observation_file, ap_file, offset, graph_file) # graph edgelist generated, feature to be added